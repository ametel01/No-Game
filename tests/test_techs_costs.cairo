...
@external
func test_combustion{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(level: felt) {
...
@external
func test_espionage{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(level: felt) {
...
@external
func test_shielding{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(level: felt) {
