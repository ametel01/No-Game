...
from main.structs import Cost, ResearchQue, TechCosts, TechLevels
...
func _espionage_tech_upgrade_cost{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    current_level: felt
) -> (metal: felt, crystal: felt, deuterium: felt) {
    let base_metal = 200;
...
func _shielding_tech_upgrade_cost{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    current_level: felt
) -> (metal: felt, crystal: felt, deuterium: felt) {
    let base_metal = 200;
...
func _hyperspace_tech_upgrade_cost{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    current_level: felt
) -> (metal: felt, crystal: felt, deuterium: felt) {
    let base_metal = 0;
    let base_crystal = 4000;
...
func _ion_tech_requirements_check{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    caller: felt
) -> () {
    alloc_locals;
    let (no_game_address) = Research_no_game_address.read();
