...
namespace ResearchLab:
    ...
    func computer_tech_upgrade_cost{
        syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr
    }(current_level : felt) -> (metal : felt, crystal : felt, deuterium : felt):
        let base_metal = 0
    ...
    func espionage_tech_upgrade_cost{
        syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr
    }(current_level : felt) -> (metal : felt, crystal : felt, deuterium : felt):
        let base_metal = 200
    ...
    func astrophysics_upgrade_cost{
        syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr
    }(current_level : felt) -> (metal : felt, crystal : felt, deuterium : felt):
        let base_metal = 4000
    ...
    func weapons_tech_upgrade_cost{
        syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr
    }(current_level : felt) -> (metal : felt, crystal : felt, deuterium : felt):
        let base_metal = 800
    ...
    func impulse_drive_upgrade_cost{
        syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr
    }(current_level : felt) -> (metal : felt, crystal : felt, deuterium : felt):
        let base_metal = 2000
        let base_crystal = 4000
    ...
    func energy_tech_requirements_check{
        ...
        let (tech_levels) = get_tech_levels(caller)
    ...
    func ion_tech_requirements_check{
        syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr
    }(caller : felt) -> ():
        let (tech_levels) = get_tech_levels(caller)
        let research_lab_level = tech_levels.research_lab
    ...
    func graviton_tech_requirements_check{
        syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr
    }(caller : felt) -> ():
        let (ogame_address) = _ogame_address.read()
    ...
    func check_trying_complete_right_tech{
        syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr
